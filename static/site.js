(() => {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    if (document.querySelector(".products-slider")) {
      const productsSlider = new core_default(".products-slider", {
        direction: "horizontal",
        loop: false,
        scrollbar: {
          el: ".swiper-scrollbar",
    ...
    if (document.querySelector(".product-gallery-slider")) {
      const productGallerySlider = new core_default(".product-gallery-slider", {
        direction: "horizontal",
        loop: false,
        scrollbar: {
          el: ".swiper-scrollbar",
    ...
    if (document.querySelector(".tabs")) {
      ...
      tabs.forEach((tab) => {
        tab.addEventListener("click", () => {
          ...
          tabContents.forEach(
            (tabContent2) => tabContent2.classList.remove("active")
          );
    ...
    if (document.querySelector(".accordion")) {
      ...
      accordionHeaders.forEach((header) => {
        ...
        header.addEventListener("click", () => {
          ...
          const accordionContent2 = header.nextElementSibling;
    ...
    if (document.querySelector(".line-left") && window.innerWidth > 768) {
      ...
      window.addEventListener("scroll", function() {
        for (let i = 0; i < lineLeftElements.length; i++) {
          ...
          const parentRect = lineLeftElements[i].parentNode.getBoundingClientRect();
          const triggerPosition = parentRect.bottom + boundingRect.top + boundingRect.height * (3 / 4) - window.innerHeight;
    ...
    if (document.querySelector(".line-right") && window.innerWidth > 768) {
      ...
      window.addEventListener("scroll", function() {
        for (let i = 0; i < lineRightElements.length; i++) {
          ...
          const triggerPosition = parentRect.bottom + boundingRect.top + boundingRect.height / 2 - window.innerHeight / 2 + window.innerHeight;
          if (window.scrollY >= triggerPosition) {
            const lineElement = document.createElement("div");
            lineElement.style.position = "absolute";
            lineElement.style.top = "50%";
